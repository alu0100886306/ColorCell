...
let RCell = require("@alu0100886306/dtable/src/RCell");
let UnderlinedCell = require("@alu0100886306/dtable/src/UnderlinedCell");
let Table = require("@alu0100886306/dtable/src/DTable");
let SCell = require("@alu0100886306/dtable/src/StrechCell")
...
describe("ColorCell", function(){
    it("Creation of ColorCell", function(){
        let cc = new ColorCell(new TCell("abc"), {"c": "blue", "bg": "White"});

        should(cc instanceof TCell).be.exactly(true);
        should(cc instanceof RCell).be.exactly(false);
    })
})
